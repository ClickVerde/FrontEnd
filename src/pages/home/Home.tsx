        ...
        <section className="h-[400px] overflow-hidden bg-seasalt flex justify-center items-center">
          <div className="flex gap-4 image-container p-[200px]">
            <div className="w-[500px] border-red flex flex-col justify-center">
              ...
              <button
                type="submit"
                className="mt-4rounded-[10px] bg-sunglow border border-sunglow hover:bg-[#f7f7f7]text-darkMossGreen textButton  text-darkMossGreen w-2/6 h-[60px] p-4 flex justify-center items-center"
              >
                <span className="flex">
                  Ver agora!
