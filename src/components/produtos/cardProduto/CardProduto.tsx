			...
			<div className="grid grid-row-3 gap-4  rounded-[30px] bg-seasalt px-6 py-4">
				<div>
					<div className="bg-[#3E5622] w-min p-1 px-2 h-min rounded-lg text-center m-4">
						<p className="text-white text-[10px] fontCategoriaProdutoCard w-max font-bold capitalize ">
							{prod.categoria?.nome}
						</p>
					</div>
					<img
						src={prod.foto}
						className=" w-[400px] h-[300px] object-cover rounded-[30px]"
						alt=""
					/>
				</div>

				<div className="grid gap-1">
					<p className=" fontProdutoNameCard text-[20px] text-darkMossGreen capitalize my-3">
						{prod.nome}
					</p>
					<div className="">
						<hr />
