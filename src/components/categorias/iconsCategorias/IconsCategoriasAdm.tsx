        ...
        <>
            <div className="grid grid-rows">
                ...
                <div className="flex ml-2 w-[45px] h-[30px] self-center ">
                    <Link to={`/editarCategoria/${categoria.id}`} className=' w-[200px] p-2 rounded-bl-lg text-black hover:text-white bg-[#FFD242] flex items-center justify-center'>
                        <button>Editar</button>
                    </Link>
                    <Link to={`/deletarCategoria/${categoria.id}`} className='w-[200px] p-2 rounded-br-lg text-black hover:text-white bg-[#FF5757] flex items-center justify-center'>
