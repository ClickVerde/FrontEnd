...
import MenuIcon from "../../assets/icons/hamburguer_menu.svg";
...
function Header() {
  ...
  if (usuario.token !== "") {
    ...
    userDropDownMobile = (
      <Menu.Items className="absolute mt-2 w-56 origin-top-right rounded-md bg-seasalt shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
        <div className="px-1 py-1">
          <Menu.Item>
            <Link
              to="/perfil"
  ...
  function headerStates(isTab: boolean, isMobile: boolean, menuClick: boolean) {
    let Estado = null;

    if (isTab) {
      Estado = (
        <>
          <header className="absolute top-0 w-full bg-white text-white align-middle py-[0.7rem] px-[0.7rem] ">
            <section className="w-full flex justify-between">
              <Link to="/home">
                <img src={Logo} className="sm:w-16 md:w-20 w-16 me-4"></img>
              </Link>

              <article className="flex gap-3 w-5/6 ">
                <div className="w-5/6 div-focus flex p-[5px] rounded-full self-center  bg-seasalt border border-emerald input-pesquisa">
                  <input
                    type="text"
                    ...
                    className="w-full h-[10px] border-none rounded-full p-2 self-center input-pesquisa"
                  />
                  <button
                ...
                {!isMobile && (
                  <div className="w-1/4  justify-around flex items-center ">
                    <div className="flex rounded-[12rem] items-center border-emerald border px-[5px]">
                      <img src={Cart} className="w-7 h-7"></img>
                      <p className="headerBtn text-darkMossGreen p-[7px]">
                        Carrinho
                      </p>
                    </div>
                  </div>
                ...
                {isMobile && (
                  <div className="flex items-center w-12 ">
                    <div className="rounded-[12rem] items-center border-emerald border p-[5px]">
                      <img src={Cart} className="w-7 h-7"></img>
                    </div>
                  </div>
                )}
            ...
            {menuClick && (
              <section>
                <div className="flex rounded-[12rem] mt-5 items-center border border-emerald p-[5px]">
                  <Menu
                    as="div"
                  ...
                  >
                    <div className="flex group">
                      <Menu.Button className="transition duration-300 ease-in-out group-hover:text-sunglow inline-flex w-full">
                        <img src={User} className="w-7 h-7"></img>
                ...
                <div className="text-darkMossGreen p-4 flex flex-col gap-4 font-bold text-[16px] ]">
                  <Link
                    to="/home"
                  ...
                  <Menu as="div" className="relative inline-block">
                    ...
                    <Transition
                      ...
                      leaveTo="transform opacity-0 scale-95"
                    >
                      <Menu.Items className="absolute inset-x-0 z-10 mt-2 w-5rounded-md bg-seasalt shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
                        <div className="px-1 py-1">
                          <Menu.Item>
                            <Link
                              to={`/categorias/all`}
  ...
  return <>{headerStates(isTab, isMobile, menuClick)}</>;
}
